...
- Status: **PROVISIONAL — implemented in `condor-qas` only, not deployed to `mi-org`.** MGAgencia has not yet confirmed they can send these fields; a heads-up was sent to them. Final field names/values may change based on their response.
