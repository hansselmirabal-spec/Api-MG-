...
**Novedades (2026-09-17):** se agregaron 4 campos opcionales nuevos: `platform`, `meta_form_id`, `campaign_name`, `campaign_description` (§4). Son adiciones no disruptivas — las integraciones existentes no se ven afectadas si se omiten.
