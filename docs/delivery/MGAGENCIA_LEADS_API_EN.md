...
**What's new (2026-09-22):** the `platform`, `meta_form_id`, `campaign_name`, `campaign_description` fields (§4, added 2026-09-17) are now **live in Production** as well as Sandbox. Non-breaking additions — no change to any existing integration that omits them.
